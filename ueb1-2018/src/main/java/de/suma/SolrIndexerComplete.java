 ...
 *
 * https://elearning.th-wildau.de/mod/resource/view.php?id=130919
 *
 * Entpacken Sie die ZIP-Datei bitte im Wurzelverzeichnis des Projekts (solr-indexer).
 *
 * Andernfalls müssen Sie die Pfade beim Zugriff auf die XML- und Textdateien anpassen.
 *
 */
public class SolrIndexerComplete {
    ...
    public static void main(String[] args) {
        ...
        SolrIndexerComplete solrIndexer = new SolrIndexerComplete();
        solrIndexer.connect();
